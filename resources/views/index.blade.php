        ...
        <div class="container">
            ...
            <section class="hero d-flex align-items-center py-4 py-lg-0 pb-xl-5 pb-xxl-0" id="hero">
                <div class="row align-items-center">
                    <div class="col-lg-7 col-xxl-6 pe-lg-5 pe-xxl-0">
                        <p class="subtitle" style="margin-bottom: 20px;" data-aos-once="true" data-aos="fade-right"
                            data-aos-duration="1400" data-aos-delay="1600">Jump into Fun, One Bounce at a Time</p>
                        <h1 class="headline" style="margin-bottom: 22px;" data-aos-once="true" data-aos="fade-right"
                            data-aos-duration="1400" data-aos-delay="2400">Reach for the Skies at <span class="light">
                        ...
                        <div class="wrapper-paragraph d-flex flex-column gap-2" style="margin-bottom: 36px;">
                            <p class="paragraph" data-aos-once="true" data-aos="fade-right" data-aos-duration="1400"
                                data-aos-delay="2800">Welcome to JumpZone, the ultimate destination for trampoline
                                enthusiasts of
                            ...
                            <p class="paragraph" data-aos-once="true" data-aos="fade-right" data-aos-duration="1400"
                                data-aos-delay="3000">Get ready to bounce, jump, and laugh as you
                                explore our
                                expansive
                        ...
                        <div class="wrapper-button d-flex gap-2 align-items-center">
                            <a href="#about" class="button-default" data-aos-once="true" data-aos="fade-right"
                                data-aos-duration="1400" data-aos-delay="300">Explore Now</a>
            ...
            <section class="adventage section-gap" id="adventage">
                <div class="row align-items-end justify-content-between row-gap">
                    <div class="col-lg-6">
                        <h2 class="title" data-aos-once="true" data-aos="fade-right" data-aos-duration="1400">Elevate
                            Your Fun, Discover the <span class="light">Advantages of
                                JumpZone</span></h2>
                    </div>
                    <div class="col-lg-5">
                        <p class="paragraph" data-aos-once="true" data-aos="fade-left" data-aos-duration="1400">Discover
                            the many benefits of JumpZone's trampoline wonderland. Our
            ...
            <section class="zone section-gap" id="zone">
                <div class="row align-items-end justify-content-between row-gap">
                    <div class="col-lg-6">
                        <h2 class="title" data-aos-once="true" data-aos="fade-right" data-aos-duration="1400">Jump
                            into the <span class="light">Ultimate Trampoline Adventure</span> at
                            JumpZone</h2>
                    </div>
                    <div class="col-lg-5">
                        <p class="paragraph" data-aos-once="true" data-aos="fade-left" data-aos-duration="1400">The
                            ultimate destination for trampoline enthusiasts. Our Trampoline Zone
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3 d-flex flex-column mb-4 mb-md-0 zone-top zone-1"
                        data-aos-once="true" data-aos="fade-left" data-aos-duration="1400">
                    ...
                    <div class="col-md-6 col-lg-3 d-flex flex-column zone-2 zone-top zone-2" data-aos-once="true"
                        data-aos="fade-left" data-aos-duration="1400" data-aos-delay="300">
                        <div class="wrapper-image rounded" style="margin-bottom: 16px;">
                    ...
                    <div class="col-lg-6 mt-4 mt-lg-0" data-aos-once="true" data-aos="zoom-in-up"
                        data-aos-duration="600" data-aos-delay="1200">
                ...
                <div class="row mt-4">
                    <div class="col-lg-6 mt-4 mt-lg-0 order-last order-lg-1" data-aos-once="true"
                        data-aos="zoom-in-up" data-aos-duration="600" data-aos-delay="1200">
                    ...
                    <div class="col-md-6 col-lg-3 d-flex flex-column order-lg-2 mb-4 mb-md-0 zone-bottom zone-1"
                        data-aos-once="true" data-aos="fade-right" data-aos-duration="1400" data-aos-delay="300">
                        <div class="wrapper-image rounded" style="margin-bottom: 16px;">
                ...
                <div class="row align-items-center justify-content-between row-gap">
                    ...
                    <div class="offset-xxl-1 col-lg-7 col-xxl-6 ps-lg-5 ps-xxl-0">
                        <h2 class="title" style="margin-bottom: 16px;" data-aos-once="true" data-aos="fade-right"
                            data-aos-duration="1400">Discover the <span class="light">Ultimate
                                Trampoline Experience</span> at
                            JumpZone</h2>
                        <div class="wrapper-paragraph d-flex flex-column gap-2" style="margin-bottom: 36px;">
                            <p class="paragraph" data-aos-once="true" data-aos="fade-right"
                                data-aos-duration="1400">The premier destination for thrilling trampoline adventures.
                                At
                            ...
                            <p class="paragraph d-none d-md-inline-block" data-aos-once="true" data-aos="fade-right"
                                data-aos-duration="1400">Join us at JumpZone and let us take you on a
                                gravity-defying journey filled with excitement, energy, and unforgettable memories.</p>
                        </div>
                        <div class="row">
                            <div class="col-6 col-md-3 mb-4 mb-md-0" data-aos-once="true" data-aos="fade-up"
                            ...
                            <div class="col-6 col-md-3" data-aos-once="true" data-aos="fade-up"
                ...
                <div class="row align-items-end justify-content-between row-gap">
                    <div class="col-lg-6">
                        <h2 class="title" data-aos-once="true" data-aos="fade-right" data-aos-duration="1400"><span
                                class="light">Safety First, Fun Always</span>, Our Commitment at
                            JumpZone</h2>
                    </div>
                    <div class="col-lg-5">
                        <p class="paragraph" data-aos-once="true" data-aos="fade-left" data-aos-duration="1400">Our
                            Safety Guidelines are designed to create a secure environment where
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        <div class="card-default d-flex flex-lg-column flex-xl-row gap-4 gap-lg-3 gap-xl-4"
                            data-aos-once="true" data-aos="zoom-in-up" data-aos-duration="600">
                            <div class="card-icon d-flex justify-content-center align-items-center">
                        ...
                        <div class="card-default d-flex flex-lg-column flex-xl-row gap-4 gap-lg-3 gap-xl-4 d-md-none mt-4"
                            data-aos-once="true" data-aos="zoom-in-up" data-aos-duration="600">
                            <div class="card-icon d-flex justify-content-center align-items-center">
                        ...
                        <div class="card-default d-flex flex-lg-column flex-xl-row gap-4 gap-lg-3 gap-xl-4 d-lg-none mt-4"
                            data-aos-once="true" data-aos="zoom-in-up" data-aos-duration="600">
                            <div class="card-icon d-flex justify-content-center align-items-center">
                        ...
                        <div class="card-default d-flex mt-4 flex-lg-column flex-xl-row gap-4 gap-lg-3 gap-xl-4 d-flex d-md-none d-lg-flex"
                            data-aos-once="true" data-aos="zoom-in-up" data-aos-duration="600">
                            <div class="card-icon d-flex justify-content-center align-items-center">
                        ...
                        <div class="card-default d-flex mt-4 flex-lg-column flex-xl-row gap-4 gap-lg-3 gap-xl-4 d-lg-none mt-4"
                            data-aos-once="true" data-aos="zoom-in-up" data-aos-duration="600">
                            <div class="card-icon d-flex justify-content-center align-items-center">
                        ...
                        <div class="card-default d-flex mt-4 flex-lg-column flex-xl-row gap-4 gap-lg-3 gap-xl-4 d-md-none"
                            data-aos-once="true" data-aos="zoom-in-up" data-aos-duration="600">
                            <div class="card-icon d-flex justify-content-center align-items-center">
                    ...
                    <div class="col-6 col-lg-4 d-none d-md-inline-block">
                        ...
                        <div class="card-default d-flex mt-4 flex-lg-column flex-xl-row gap-4 gap-lg-3 gap-xl-4 d-lg-none"
                            data-aos-once="true" data-aos="zoom-in-up" data-aos-duration="600">
                            <div class="card-icon d-flex justify-content-center align-items-center">
                                <h4 class="guide-number">4</h4>
                            </div>
                        ...
                        <div class="card-default d-flex mt-4 flex-lg-column flex-xl-row gap-4 gap-lg-3 gap-xl-4 d-none d-lg-flex"
                            data-aos-once="true" data-aos="zoom-in-up" data-aos-duration="600">
                            <div class="card-icon d-flex justify-content-center align-items-center">
                                <h4 class="guide-number">5</h4>
                            </div>
                ...
                <div class="row align-items-end justify-content-between row-gap">
                    <div class="col-lg-6">
                        <h2 class="title" data-aos-once="true" data-aos="fade-right" data-aos-duration="1400">
                            JumpZone in Action, <span class="light">Explore the
                                Excitement in</span> Our
                            Gallery</h2>
                    </div>
                    <div class="col-lg-5">
                        <p class="paragraph" data-aos-once="true" data-aos="fade-left" data-aos-duration="1400">Get
                            a front-row seat to the excitement and exhilaration as you browse
                ...
                <div class="row">
                    <div class="col-8 col-lg-6 d-none d-md-inline-block">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="wrapper-image rounded" data-aos-once="true" data-aos="zoom-in-up"
                                    data-aos-duration="600">
                                    <img src="{{ asset('assets/img/gallery/gallery-2.svg') }}"
                                        class="image-2 img-fluid w-100" alt="Gallery Image">
                                </div>
                                <div class="wrapper-image rounded mt-4" data-aos-once="true" data-aos="zoom-in-up"
                                    data-aos-duration="600">
            ...
            <section class="pricing section-gap" id="pricing">
                <div class="row align-items-end justify-content-between row-gap">
                    <div class="col-lg-6">
                        <h2 class="title" data-aos-once="true" data-aos="fade-right" data-aos-duration="1400">
                            Pricing Made Easy, <span class="light">Experience the Value</span> at
                            JumpZone</h2>
                    </div>
                    <div class="col-lg-5">
                        <p class="paragraph" data-aos-once="true" data-aos="fade-left" data-aos-duration="1400">
                            JumpZone offers flexible and affordable pricing options designed to suit
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-4">
                        ...
                        <div class="card-default mt-4 d-none d-md-inline-block d-lg-none" data-aos-once="true"
                            data-aos="zoom-in-up" data-aos-duration="600">
            ...
            <section class="testimoni section-gap" id="testimoni">
                <div class="row align-items-center justify-content-between row-gap">
                    <div class="col-lg-7 col-xxl-6 pe-lg-5 pe-xxl-0">
                        <h2 class="title" style="margin-bottom: 16px;" data-aos-once="true" data-aos="fade-right"
                            data-aos-duration="1400">JumpZone Delights, <span class="light">Hear
                                What Our Jumpers</span> Have
                            to Say</h2>
                        <p class="paragraph" style="margin-bottom: 36px" data-aos-once="true" data-aos="fade-right"
                            data-aos-duration="1400">Discover the real experiences and heartfelt
            ...
            <section class="faq section-gap" id="faq">
                <div class="row align-items-end justify-content-between row-gap">
                    <div class="col-lg-6">
                        <h2 class="title" data-aos-once="true" data-aos="fade-right" data-aos-duration="1400"><span
                                class="light">JumpZone Info Hub</span>, Find Answers to Your
                            <span class="light">Trampoline Queries</span>
                        </h2>
                    </div>
                    <div class="col-lg-5">
                        <p class="paragraph" data-aos-once="true" data-aos="fade-left" data-aos-duration="1400">
                            Where we address common questions and provide helpful answers to ensure
